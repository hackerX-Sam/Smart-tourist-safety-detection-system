...
export const translations: Record<string, Translations> = {
  en: {
    ...
    rainPossibleIn2Hours: "Rain possible in 2 hours",
    patternAnalysis: "Pattern analysis: Higher incident rate near metro stations",
    higherIncidentRateNearMetro: "Higher incident rate near metro stations",
  ...
  fr: {
    ...
    rainPossibleIn2Hours: "Pluie possible dans 2 heures",
    patternAnalysis: "Analyse des modèles: Taux d'incidents plus élevé près des stations de métro",
    higherIncidentRateNearMetro: "Taux d'incidents plus élevé près des stations de métro",
  ...
  de: {
    ...
    rainPossibleIn2Hours: "Regen in 2 Stunden möglich",
    patternAnalysis: "Musteranalyse: Höhere Vorfallrate in der Nähe von U-Bahn-Stationen",
    higherIncidentRateNearMetro: "Höhere Vorfallrate in der Nähe von U-Bahn-Stationen",
  ...
  ja: {
    ...
    rainPossibleIn2Hours: "2時間後に雨の可能性",
    patternAnalysis: "パターン分析：地下鉄駅近くでのインシデント率が高い",
    higherIncidentRateNearMetro: "地下鉄駅近くでのインシデント率が高い",
  ...
  hi: {
    ...
    rainPossibleIn2Hours: "2 घंटे में बारिश की संभावना",
    patternAnalysis: "पैटर्न विश्लेषण: मेट्रो स्टेशनों के पास अधिक घटना दर",
    higherIncidentRateNearMetro: "मेट्रो स्टेशनों के पास अधिक घटना दर",
  ...
  es: {
    ...
    rainPossibleIn2Hours: "Posible lluvia en 2 horas",
    patternAnalysis: "Análisis de patrones: Mayor tasa de incidentes cerca de estaciones de metro",
    higherIncidentRateNearMetro: "Mayor tasa de incidentes cerca de estaciones de metro",
